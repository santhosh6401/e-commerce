...
public class MessageContentConfigService {
    ...
    public MessageContentConfigResponse createMessageContent(MessageContentConfigRequest request, String uniqueInteractionId) {
        ...
        if (Objects.isNull(request.getName()) || Objects.isNull(request.getMessageContent()) || Objects.isNull(request.getMessagingChannel())) {
        ...
        try {
            ...
            contentConfig.setStatusLifeCycles(utils.upsertStatusLifeCycles(" new message content created for the channel " + request.getMessagingChannel() + " , message content " + request.getMessageContent(), contentConfig.getStatusLifeCycles()));
    ...
    public MessageContentConfigResponse updateMessageContent(MessageContentConfigRequest request, String uniqueInteractionId) {
        ...
        try {
            ...
            contentConfig.setStatusLifeCycles(utils.upsertStatusLifeCycles("message config updated for the channel " + request.getMessagingChannel() + " , message content " + request.getMessageContent(), contentConfig.getStatusLifeCycles()));
            repository.save(contentConfig);
    ...
    public List<MessageContentConfigResponse> getMessageContent(String name, MessagingChannel messagingChannel) {
